...
public class HibernateDao {
	 ...
	 *         	 	数据访问出错时抛出的exception
	 */
	public <T extends BaseEntity> void create(T t, String creationErrorMsg) 
		throws DataCreationException{
		
		if (t == null)
			throw new IllegalArgumentException("can not create a null bean");
		try{
			entityManager.persist(t);
		}catch (Exception e) {
			throw new DataCreationException(creationErrorMsg);
		} 
	 ...
	 *              数据访问出错时抛出的exception
	 */
	public <T extends BaseEntity> void update(T t, String updateErrorMsg) 
			throws DataUpdateException{
		if (t == null)
		...
		try{
			...
			throw new DataUpdateException(updateErrorMsg);
		}
	}
	/**
	 * T delete
