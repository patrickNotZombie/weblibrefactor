...
<script src="../js/DCampus.AuditThreads.js"></script>
<script>
...
<body>
<script>
var auditThreadsJSON =  <ww:action name='getAuditThreads' namespace='/thread' executeResult='true' ignoreContextParams='false'><ww:param name="groupId" value="%{#request.mygroupId}"></ww:param><ww:param name="start" value="0"></ww:param><ww:param name="limit" value="20"></ww:param></ww:action>
<%if(getService(session).getPermissionManager().hasGroupPermission(groupId,IPermission.GroupPerm.MANAGE_MEMBER_REQUEST)){%>
DCampus.AuditThreadsUI.mygroupId = <%=mygroupId%>;//设置groupId
<%}%>
</script>
