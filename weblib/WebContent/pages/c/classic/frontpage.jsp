...
DCampus.FrontpageData = {
   ...
   ,_getGroupNewsSuccess : function(data){
	   DCampus.Public.AjaxRequestFunction("/group/getImpersonalGroupRecords.action?temp="+Math.random(),"start=0&limit=10","get",DCampus.FrontpageData._getGroupNewsLstSuccess);//然后异步请求输出圈子的动态列表
	},
