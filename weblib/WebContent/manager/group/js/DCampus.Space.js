	...
	$(".container002").DCampusPaging({
		...
		,"onComplete" : function(){
			                ...
			                $(".saveSingle").bind("click",function(){
								DCampus.Public.AjaxRequestFunction(System.site+"/group/modifySingleFileSize.action", "id="+$(this).attr("id")+"&filesize="+$(this).parent().find("span input").val(),"post", DCampus.GroupsData._saveSucecess);								   
			                ...
			                $(".saveSpace").bind("click",function(){
								DCampus.Public.AjaxRequestFunction(System.site+"/group/modifyTotalFileSize.action", "id="+$(this).attr("id")+"&filesize="+$(this).parent().find("span input").val(),"post", DCampus.GroupsData._saveSucecess);								  
						         /*$(this).parent().find("span").text($(this).parent().find("span input").val());
								 $(this).addClass("displayNone");
