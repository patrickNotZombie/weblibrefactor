 ...
 **/
 ...
 /**
    请求发件箱列表
 **/
   DCampus.InboxUI._getInboxList(System.site+"/user/getInboxMessage.action");
		...
		tabFunction : function(thisObj){/**滑动tab效果**/
			...
			$(".tabCover").animate({left:thisObj.offset().left-20+"px"},"fast",function(){/**给每个tab绑定一个事件**/
				switch($(".tabHanddle").find("a").index(thisObj)) {
				   case 0:DCampus.InboxUI._getInboxList(System.site+"/user/getInboxMessage.action");break;
				   case 1:DCampus.InboxUI._getInboxList(System.site+"/user/getSentboxMessage.action");break;
				   case 2:
					 /**调用发短消息模板**/
