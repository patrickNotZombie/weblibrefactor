...
$(function(){
	...
	$(".btn-close-groups").bind("click",function(){
		...
		DCampus.Public.AjaxRequestFunction(System.site + "/group/closeGroup.action",param,"POST",DCampus.GroupsData._requestSuccess);	  
	...
	$(".btn-open-groups").bind("click",function(){
		...
		$.each($(".slct-tbl td :checked"),function(n,o){
         ...
         DCampus.Public.AjaxRequestFunction(System.site + "/group/restoreGroup.action",param,"POST",DCampus.GroupsData._requestSuccess);	  	
		 $(".container002").DCampusPaging("reflash");
	});		
	$("#redoIndex").bind("click",function(){
	   DCampus.Public.AjaxRequestFunction(System.site + "/group/rebuildGroupIndex.action","","POST",DCampus.GroupsData._requestSuccess);
	});
