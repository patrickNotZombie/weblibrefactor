...
<div class="frame_content">
  <div id="breadCrumb"><span class="breadLeft"><span class="breadRight"><span class="breadTitle"><a href="#">资源库</a> &gt; <a href="#">资源库设置</a> </span> </span></span></div>
...
<div class="tablewrap">
 ...
 <tr class="noborder">
  ...
  <tr class="noborder">
    <td><strong>关闭资源库</strong></td>
  </tr>
    <tr>
    <td><input type="radio" name="site_close" checked="checked" class="settingValue" value="false"/> 打开资源库 <input type="radio" name="site_close" class="settingValue" value="true"/> 关闭资源库</td>
  </tr>
    <tr class="noborder">
